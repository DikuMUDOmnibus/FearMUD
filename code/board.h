...
struct global_board_data
{
   ...
   int read_level; /* minimum level to read board */
   int write_level; /* minimum level to write notes */
   int see_level; /* minimum level to see board/can write but cannot read */
