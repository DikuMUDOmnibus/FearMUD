...
*/
   ...
   service =
      CreateService(SCmanager, THIS_SERVICE, THIS_SERVICE_DISPLAY, SERVICE_ALL_ACCESS, SERVICE_WIN32_OWN_PROCESS, SERVICE_AUTO_START,
      SERVICE_ERROR_NORMAL, fullfilename, NULL, // no load ordering group
...
static char *convert_error(DWORD error)
{
   ...
   if (!FormatMessage(FORMAT_MESSAGE_FROM_SYSTEM |
         FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_IGNORE_INSERTS, NULL, error, LANG_NEUTRAL, (LPTSTR) & formattedmsg, 0, NULL))
   {
